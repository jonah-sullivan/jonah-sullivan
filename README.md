...
- Contributor to the OSGeo ecosystem  
- Director of [OSGeo Oceania](https://osgeo-oceania.org/) and organiser of regional events
- Organiser of the [Canberra Python User Group](https://www.meetup.com/canberra-python-meetup-group/)
- Contributor to open source geospatial tooling and workflows 

## What I Work On

- QGIS plugin development and tooling  
- Python-based geospatial workflows  
- CLI tools and automation for GIS development  
- Open source contributions in the geospatial ecosystem  
